...
func (x *GetUserInfoResp) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_apps_user_rpc_user_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x64, 0x22, 0x4d, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	...
	0x64, 0x73, 0x22, 0x37, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0x34, 0x0a, 0x0c, 0x46,
	...
	0x72, 0x32, 0xf9, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x25, 0x0a, 0x04, 0x50, 0x69,
	...
	0x2e, 0x46, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x42, 0x08, 0x5a,
...
var file_apps_user_rpc_user_proto_depIdxs = []int32{
	0,  // 0: user.FindUserResp.user:type_name -> user.UserEntity
	1,  // 1: user.User.Ping:input_type -> user.Request
	3,  // 2: user.User.Login:input_type -> user.LoginReq
	5,  // 3: user.User.Register:input_type -> user.RegisterReq
	7,  // 4: user.User.GetUserInfo:input_type -> user.GetUserInfoReq
	9,  // 5: user.User.FindUser:input_type -> user.FindUserReq
	2,  // 6: user.User.Ping:output_type -> user.Response
	4,  // 7: user.User.Login:output_type -> user.LoginResp
	6,  // 8: user.User.Register:output_type -> user.RegisterResp
	8,  // 9: user.User.GetUserInfo:output_type -> user.GetUserInfoResp
	10, // 10: user.User.FindUser:output_type -> user.FindUserResp
